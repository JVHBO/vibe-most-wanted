...
export function SpectatorBetFeedback({
  ...
  return (
    <>
      ...
      {/* Bet History Panel - Fixed at top right (near corner) */}
      <div className="fixed top-4 right-4 z-[200] bg-vintage-charcoal/95 backdrop-blur-md border border-purple-500/50 rounded-lg p-2 shadow-xl w-36 text-xs">
        {/* Compact Header */}
