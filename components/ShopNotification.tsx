...
export function ShopNotification({ type, message, onClose }: ShopNotificationProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
      <div
        className={`relative max-w-md w-full rounded-2xl p-6 shadow-2xl transform animate-slideUp ${
          isSuccess
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-vintage-ice/50 hover:text-vintage-ice transition-colors"
        >
        ...
        <div className="flex items-center justify-center mb-4">
          {isSuccess ? (
            <div className="w-16 h-16 rounded-full bg-vintage-gold/20 flex items-center justify-center">
              <svg className="w-10 h-10 text-vintage-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center">
          ...
          <p className="text-vintage-ice text-base leading-relaxed">
            {message}
          </p>
        </div>
