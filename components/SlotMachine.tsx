                  ...
                  <div className="space-y-3">
                    ...
                    <div className="rounded-lg overflow-hidden" style={{ border:"1px solid #2a2a2a" }}>
                      ...
                      <div className="px-2 py-1.5 space-y-0.5" style={{ background:"#0d0d0d" }}>
                        {[
                          { label:t.helpCombosPayoutAceLabel,   color:"#a855f7", payout:"700%" },
                          { label:t.helpCombosPayoutKingLabel,  color:"#f59e0b", payout:"500%"  },
                          { label:t.helpCombosPayoutQueenLabel, color:"#ec4899", payout:"400%"  },
                          { label:t.helpCombosPayoutJackLabel,  color:"#3b82f6", payout:"320%" },
                          { label:t.helpCombosPayoutTenLabel,   color:"#06b6d4", payout:"260%"  },
                          { label:t.helpCombosPayoutNineLabel,  color:"#10b981", payout:"215%"  },
                          { label:t.helpCombosPayoutEightLabel, color:"#84cc16", payout:"175%"  },
                          { label:t.helpCombosPayoutSevenLabel, color:"#eab308", payout:"140%"  },
                          { label:t.helpCombosPayoutTwoToSixLabel, color:"#6b7280", payout:"30–110%"},
                        ].map(r => (
