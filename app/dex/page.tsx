...
export default function DexPage() {
  ...
  return (
    <div className="h-full flex flex-col bg-vintage-deep-black text-vintage-ice overflow-hidden" style={{ minHeight: "100%" }}>
      ...
      {/* Bonding Info Modal */}
      {showBondingInfo && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[10000] flex items-start justify-center pt-14 pb-20 px-3 overflow-hidden">
          <div className="bg-vintage-deep-black border-2 border-vintage-gold/50 rounded-2xl max-w-md w-full p-4 shadow-2xl max-h-[80vh] overflow-y-auto overflow-x-hidden">
            {/* Header */}
