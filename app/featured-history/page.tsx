...
export default function FeaturedHistoryPage() {
  ...
  return (
    <div className="min-h-screen bg-vintage-deep-black">
      {/* Header */}
      <div className="border-b-2 border-vintage-gold/30" style={{ background: "#1A1A1A", position: "sticky", top: 0, zIndex: 50 }}>
        <div className="max-w-4xl mx-auto px-3 py-2.5 flex items-center justify-between">
          ...
          <h1 className="text-vintage-gold font-bold text-lg tracking-wider">
            Hall of Fame
          </h1>
          <div className="w-16" />
        </div>
