                  ...
                  <>
                    ...
                    <div className="relative p-1 rounded-xl" style={{background: 'linear-gradient(145deg, #FFD700, #C9A227, #FFD700)', boxShadow: '0 0 20px rgba(255, 215, 0, 0.4)', animation: 'pulse 2s ease-in-out infinite'}}>
                      <div className="bg-vintage-black/90 p-3 md:p-5 rounded-lg">
                        ...
                        <button
                          onClick={() => openMarketplace('https://farcaster.xyz/miniapps/xsWpLUXoxVN8/vibemarket/market/vibe-most-wanted?ref=XCLR1DJ6LQTT', sdk, isInFarcaster)}
                ...
                {nfts.length === 0 && status !== 'fetching' && (
                  <div className="text-center py-12 px-4">
                    ...
                    <button
                      onClick={async () => {
                        if (soundEnabled) AudioManager.buttonClick();
                        await openMarketplace('https://farcaster.xyz/miniapps/xsWpLUXoxVN8/vibemarket/market/vibe-most-wanted?ref=XCLR1DJ6LQTT', sdk, isInFarcaster);
                      }}
