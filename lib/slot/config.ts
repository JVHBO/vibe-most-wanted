...
export const SLOT_CARD_POOL: SlotCardDefinition[] = [
  ...
  { baccarat: "jesse", rarity: "Mythic", weight: 10 },
  { baccarat: "anon", rarity: "Mythic", weight: 10 },
  { baccarat: "linda xied", rarity: "Mythic", weight: 10 },
  { baccarat: "vitalik jumpterin", rarity: "Mythic", weight: 10 },
  { baccarat: "antonio", rarity: "Legendary", weight: 14 },
  { baccarat: "goofy romero", rarity: "Legendary", weight: 14 },
  { baccarat: "tukka", rarity: "Legendary", weight: 14 },
  { baccarat: "chilipepper", rarity: "Legendary", weight: 14 },
  { baccarat: "miguel", rarity: "Legendary", weight: 14 },
  { baccarat: "naughty santa", rarity: "Legendary", weight: 14 },
  { baccarat: "ye", rarity: "Legendary", weight: 14 },
  { baccarat: "nico", rarity: "Legendary", weight: 14 },
  { baccarat: "sartocrates", rarity: "Epic", weight: 20 },
  { baccarat: "0xdeployer", rarity: "Epic", weight: 20 },
  { baccarat: "lombra jr", rarity: "Epic", weight: 20 },
  { baccarat: "vibe intern", rarity: "Epic", weight: 20 },
  { baccarat: "jack the sniper", rarity: "Epic", weight: 20 },
  { baccarat: "beeper", rarity: "Epic", weight: 20 },
  { baccarat: "horsefarts", rarity: "Epic", weight: 20 },
  { baccarat: "jc denton", rarity: "Epic", weight: 20 },
  { baccarat: "zurkchad", rarity: "Epic", weight: 20 },
  { baccarat: "slaterg", rarity: "Epic", weight: 20 },
  { baccarat: "brian armstrong", rarity: "Epic", weight: 20 },
  { baccarat: "nftkid", rarity: "Epic", weight: 20 },
