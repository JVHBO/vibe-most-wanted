...
export const COMBO_TRANSLATION_KEYS: Record<string, string> = {
  four_aces: "tcgComboFourAces",
  four_kings: "tcgComboFourKings",
  four_queens: "tcgComboFourQueens",
  four_jacks: "tcgComboFourJacks",
  four_tens: "tcgComboFourTens",
  four_nines: "tcgComboFourNines",
  four_eights: "tcgComboFourEights",
  four_sevens: "tcgComboFourSevens",
  four_fives: "tcgComboFourFives",
  four_fours: "tcgComboFourFours",
  four_threes: "tcgComboFourThrees",
  four_twos: "tcgComboFourTwos",
  four_dragukkas: "tcgComboFourDragukkas",
};
