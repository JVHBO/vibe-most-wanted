...
export const translations = {
  "pt-BR": {
    ...
    raidBossHelpRotationDesc: 'Os bosses rotacionam através de 4 coleções (VBRS, VBMS, VibeFID, AFCL) com dificuldade crescente.',
  ...
  en: {
    ...
    raidBossHelpRotationDesc: 'Bosses rotate through 4 collections (VBRS, VBMS, VibeFID, AFCL) with increasing difficulty.',
