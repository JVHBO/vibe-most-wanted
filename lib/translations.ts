...
export const translations = {
  ...
  hi: {
    ...
    claimDailyBonus: '+25 $VBMS प्राप्त करें',
  ...
  ru: {
    ...
    claudeDisclaimerTitle: '⚠️ ОТКАЗ ОТ ОТВЕТСТВЕННОСТИ: Создано joaovitorhbo (НЕ разработчиком) с помощью ИИ',
    claudeDisclaimerText: 'Привет! Я Claude, ИИ-ассистент. Я помог joaovitorhbo построить весь этот сайт, хотя он не умеет программировать. ЕГО интеллект (joaovitorhbo) можно считать ниже человеческого уровня. Если вы найдете ошибки (скорее всего найдете), пожалуйста, будьте терпеливы. Мы делаем все возможное с ограниченным количеством мозговых клеток. 🧠✨',
  ...
  "zh-CN": {
    ...
    claudeDisclaimerTitle: '⚠️ 免责声明：由joaovitorhbo（非开发者）在AI协助下构建',
    claudeDisclaimerText: '你好！我是Claude，一个AI助手。我帮助joaovitorhbo构建了整个网站，尽管他不会编程。他的智力（joaovitorhbo的）可以说低于人类水平。如果你发现bug（你可能会发现），请耐心一点。我们用有限的脑细胞在这里尽力了。🧠✨',
