...
export const SOCIAL_QUESTS: SocialQuest[] = [
  ...
  },
  {
    ...
    description: 'The Vinyls creator',
    reward: 50,
    icon: '',
  ...
  },
  {
    ...
    description: 'OnchainDare creator',
    reward: 50,
    icon: '',
  ...
  },
  {
    ...
    description: 'Astroblock creator',
    reward: 50,
    icon: '',
