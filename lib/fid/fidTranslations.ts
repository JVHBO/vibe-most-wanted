...
export const fidTranslations = {
  "pt-BR": {
    ...
    questVibemailHeader: 'Quest VibeMail',
    questFollowBadge: 'Seguir',
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: 'Ver Perfil',
    questClaimVbms: 'Resgatar +{amount} VBMS',
    questClaimed: '✓ Resgatado',
    questMiniAppLabel: 'Mini App',
    questOpenApp: 'Abrir App',
    questJoinChannel: 'Entrar no Canal',
    questFarcasterChannel: 'Canal Farcaster',
    questRewardLabel: 'Recompensa',
    questClaimMailVbms: 'Resgatar VBMS',
    questClaimedMail: 'Resgatado!',
    inboxTab: 'Recebidos',
    sentTab: 'Enviados',
    sentTo: 'Para',
  ...
  "en": {
    ...
    questVibemailHeader: 'Quest VibeMail',
    questFollowBadge: 'Follow',
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: 'Go to Profile',
    questClaimVbms: 'Claim +{amount} VBMS',
    questClaimed: '✓ Claimed',
    questMiniAppLabel: 'Mini App',
    questOpenApp: 'Open App',
    questJoinChannel: 'Join Channel',
    questFarcasterChannel: 'Farcaster Channel',
    questRewardLabel: 'Reward',
    questClaimMailVbms: 'Claim VBMS',
    questClaimedMail: 'Claimed!',
    inboxTab: 'Inbox',
    sentTab: 'Sent',
    sentTo: 'To',
  ...
  "es": {
    ...
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: 'Ver Perfil',
    questClaimVbms: 'Reclamar +{amount} VBMS',
    questClaimed: '✓ Reclamado',
    questMiniAppLabel: 'Mini App',
    questOpenApp: 'Abrir App',
    questJoinChannel: 'Unirse al Canal',
    questFarcasterChannel: 'Canal de Farcaster',
    questRewardLabel: 'Recompensa',
    questClaimMailVbms: 'Reclamar VBMS',
    questClaimedMail: '¡Reclamado!',
    inboxTab: 'Recibidos',
    sentTab: 'Enviados',
    sentTo: 'Para',
  ...
  "hi": {
    ...
    questVibemailHeader: 'Quest VibeMail',
    questFollowBadge: 'फॉलो करें',
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: 'प्रोफ़ाइल देखें',
    questClaimVbms: '+{amount} VBMS क्लेम करें',
    questClaimed: '✓ क्लेम किया',
    questMiniAppLabel: 'मिनी ऐप',
    questOpenApp: 'ऐप खोलें',
    questJoinChannel: 'चैनल जॉइन करें',
    questFarcasterChannel: 'Farcaster चैनल',
    questRewardLabel: 'इनाम',
    questClaimMailVbms: 'VBMS क्लेम करें',
    questClaimedMail: 'क्लेम हो गया!',
    inboxTab: 'प्राप्त',
    sentTab: 'भेजे गए',
    sentTo: 'को',
  ...
  "ru": {
    ...
    questVibemailHeader: 'Quest VibeMail',
    questFollowBadge: 'Подписаться',
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: 'Перейти в профиль',
    questClaimVbms: 'Получить +{amount} VBMS',
    questClaimed: '✓ Получено',
    questMiniAppLabel: 'Мини-приложение',
    questOpenApp: 'Открыть',
    questJoinChannel: 'Вступить в канал',
    questFarcasterChannel: 'Канал Farcaster',
    questRewardLabel: 'Награда',
    questClaimMailVbms: 'Получить VBMS',
    questClaimedMail: 'Получено!',
    inboxTab: 'Входящие',
  ...
  "zh-CN": {
    ...
    questFollowBadge: '关注',
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: '查看主页',
    questClaimVbms: '领取 +{amount} VBMS',
    questClaimed: '✓ 已领取',
    questMiniAppLabel: '小程序',
    questOpenApp: '打开应用',
    questJoinChannel: '加入频道',
    questFarcasterChannel: 'Farcaster 频道',
    questRewardLabel: '奖励',
    questClaimMailVbms: '领取 VBMS',
    questClaimedMail: '已领取！',
    inboxTab: '收件箱',
    sentTab: '已发送',
    sentTo: '发送给',
  ...
  "id": {
    ...
    questVibemailHeader: 'Quest VibeMail',
    questFollowBadge: 'Ikuti',
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: 'Ke Profil',
    questClaimVbms: 'Klaim +{amount} VBMS',
    questClaimed: '✓ Diklaim',
    questMiniAppLabel: 'Mini App',
    questOpenApp: 'Buka App',
    questJoinChannel: 'Gabung Channel',
    questFarcasterChannel: 'Channel Farcaster',
    questRewardLabel: 'Hadiah',
    questClaimMailVbms: 'Klaim VBMS',
    questClaimedMail: 'Diklaim!',
  ...
  "fr": {
    ...
    questVibemailHeader: 'Quest VibeMail',
    questFollowBadge: 'Suivre',
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: 'Voir le Profil',
    questClaimVbms: 'Réclamer +{amount} VBMS',
    questClaimed: '✓ Réclamé',
    questMiniAppLabel: 'Mini App',
    questOpenApp: 'Ouvrir',
    questJoinChannel: 'Rejoindre le Canal',
    questFarcasterChannel: 'Canal Farcaster',
    questRewardLabel: 'Récompense',
    questClaimMailVbms: 'Réclamer VBMS',
    questClaimedMail: 'Réclamé!',
    inboxTab: 'Reçus',
    sentTab: 'Envoyés',
    sentTo: 'À',
  ...
  "ja": {
    ...
    backToInbox: '受信箱に戻る',
    questVibemailHeader: 'Quest VibeMail',
    questFollowBadge: 'フォロー',
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: 'プロフィールへ',
    questClaimVbms: '+{amount} VBMS 受け取る',
    questClaimed: '✓ 受取済み',
    questMiniAppLabel: 'ミニアプリ',
    questOpenApp: 'アプリを開く',
    questJoinChannel: 'チャンネルに参加',
    questFarcasterChannel: 'Farcasterチャンネル',
    questRewardLabel: '報酬',
    questClaimMailVbms: 'VBMS 受け取る',
    questClaimedMail: '受取済み！',
    inboxTab: '受信',
    sentTab: '送信済み',
    sentTo: '宛先',
  ...
  "it": {
    ...
    questVibemailHeader: 'Quest VibeMail',
    questFollowBadge: 'Segui',
    questVibefidHolder: 'VibeFID Holder',
    questGoToProfile: 'Vai al Profilo',
    questClaimVbms: 'Riscatta +{amount} VBMS',
    questClaimed: '✓ Riscattato',
    questMiniAppLabel: 'Mini App',
    questOpenApp: 'Apri App',
    questJoinChannel: 'Unisciti al Canale',
    questFarcasterChannel: 'Canale Farcaster',
    questRewardLabel: 'Ricompensa',
    questClaimMailVbms: 'Riscatta VBMS',
    questClaimedMail: 'Riscattato!',
    inboxTab: 'Ricevuti',
    sentTab: 'Inviati',
    sentTo: 'A',
