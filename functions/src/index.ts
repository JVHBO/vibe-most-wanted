...
interface UpdateTwitterRequest {
  address: string;
  twitter: string;
}
...
export const recordMatch = functions.https.onCall(async (data: RecordMatchRequest, context) => {
...
export const updateStats = functions.https.onCall(async (data: UpdateStatsRequest, context) => {
...
export const updateTwitter = functions.https.onCall(async (data: UpdateTwitterRequest, context) => {
...
export const cleanupOldRooms = functions.pubsub.schedule('every 5 minutes').onRun(async (context) => {
